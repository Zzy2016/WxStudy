...
Page({
  ...
  // 选择天数
  doCheckDay:function(e){
    console.log(e.detail.value)
    var queIndex = this.data.questionIndex-1
    var index = e.detail.value
    this.setData({
      ['ansArr['+queIndex+']']:index, 
    })
  },

  // //选择程度
  // doSelectLevel:function(e){
  //   console.log("选择程度"+e.detail.value)  //这里是选择答案的Index
  //   var queIndex = this.data.questionIndex - 1
  //   var index = e.detail.value
  //   this.setData({
  //     ['ansArr[' + queIndex + ']']: index, 
